package com.example.bananacamaraapp
...
import com.example.bananacamaraapp.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == Constants.REQUEST_CODE_PERMISSIONS){
            if (!allPermissionsGranted()){
                Toast.makeText(this, "Permisions not granted.", Toast.LENGTH_LONG).show()
                finish()
            }
